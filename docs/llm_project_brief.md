...
- `src/react/game/expedition.js`
  - 직업 동료 기반 원정대, 5인 파티, 실시간 역할 전투, 자동 정산, 즉시/pending 보상, stage 진행, 성장 투자, 승급 합성을 담당한다.
...
- 원정대: 챕터 10개, stage 100개, 보스 100개, 직업 역할 전투 스탯 62개, 일반/보스 전투 enemy 설정 각 100개, 유닛 레벨 600개
