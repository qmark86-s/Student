...
const checklist = {
  ...
  tabs: ["성장", "시험", "장비", "직장", "교육", "결과", "도감"],
  growth: ["보유 공부량", "누적 공부량", "처치한 책", "장착 장비", "전투력", "교육 성장 배율", "자동 투자 비율", "직접 설정", "합계", "최대"],
  education: ["조기교육", "선행학습", "사립초 전학", "사립중 전학", "특목고 전학", "논술 스튜디오", "과학 탐구반", "N수 과외", "진로 컨설팅"],
  shop: ["SHOP", "보유 다이아", "문방구", "서점", "다이아 한 줌", "모의고사 다이아 상자", "결제 준비중", "패키지", "패스", "광고"],
  settings: ["MENU", "자동 저장", "계정 / 저장", "알림", "사운드 / 조작", "성능", "지원", "위험 구역", "저장 초기화"],
  debug: ["DEBUG", "데이터 관리", "다이아 +10K", "대원 후보 +1", "대원 후보 +5", "현재 결과 재계산", "세이브 내보내기", "세이브 불러오기", "세이브 JSON"],
};
