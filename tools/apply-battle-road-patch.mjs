...
const curriculumConfigPath = resolve("data/curriculum_attack_vfx.json");

const battleRoadConfig = JSON.parse(readFileSync(configPath, "utf8"));
const curriculumAttackVfx = JSON.parse(readFileSync(curriculumConfigPath, "utf8"));
...
const curriculumLiteral = JSON.stringify(curriculumAttackVfx);
