...
replaceBetween(
  ...
  "function Sa(",
  "function xa({outcome:e,universityId:t,setState:n,onAccepted:r}){return e.careerCandidates.length===0?(0,P.jsx)(ja,{text:`직업 선택지 없음`}):(0,P.jsx)(`div`,{className:`career-choice-list career-choice-ranked`,children:e.careerCandidates.map(e=>{let i=O.careerById[e.careerId],a=!!t&&e.selectable!==!1,o=e.choiceRank??i?.choiceRank,s=e.powerMultiplier??i?.powerMultiplier??1,c=e.minPrestige??i?.minPrestige??0;return(0,P.jsxs)(`button`,{className:a?`career-choice ranked`:`career-choice ranked locked`,type:`button`,disabled:!a,onClick:()=>{a&&(L(n,n=>yi(n,t,O,e.careerId)),r?.())},children:[(0,P.jsx)(`span`,{className:`career-choice-rank`,children:o?`#${o}`:`#-`}),(0,P.jsx)(`span`,{className:`career-choice-aura career-portrait career-gender-${e.avatarGender??`male`} career-${(i?.id??e.careerId).replace(/[^a-z0-9_-]/gi,``)}`,style:{backgroundColor:i?.auraColor??`#94a3b8`}}),(0,P.jsxs)(`span`,{className:`career-choice-main`,children:[(0,P.jsx)(`strong`,{children:e.name}),(0,P.jsxs)(`small`,{children:[e.choiceBand??`직업`, ` · Tier `,e.tier,` · 요구 `,c,` · `,fn(e.incomePerMinute),`원/분`]})]}),(0,P.jsx)(`b`,{className:`career-choice-state`,children:a?`전투 x${s.toFixed(2)}`:e.lockedReason??`잠김`})]},e.careerId)})})}",
