...
> 최신 기준: 이 문서는 초기 PNG 스프라이트 패밀리화 기록이다. 원정대 몬스터는 이후 80종으로 확장되었고, 현재 외형 기준은 `implementations/expedition-monster-raster-png-redraw/implementation.md`의 tone별 래스터 PNG 원본 시트 방식이다.
