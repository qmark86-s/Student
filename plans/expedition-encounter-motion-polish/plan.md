...
> 최신 기준: `plans/expedition-backdrop-commercial-qa/plan.md` 차수 이후 Stage당 배경 이동 거리는 `80px`, route tile 교체 주기는 `25 Stage`다. 아래 `300px/100 Stage` 내용은 이전 감각 튜닝 기록이다.
...
- `react:expedition-smoke`
  - Stage 1 -> 2 이동 배경 offset이 0 -> -80인지 검사한다.
